<div class="row">
	...
	foreach ($berita as $berita) { ?>
		<div class="col-md-4 berita">
			...
			<h2><a href="<?php echo base_url('home2/read/' . $berita['slug_berita']) ?>"><?php echo $berita['judul_berita'] ?></a></h2>
			<p><?php echo strip_tags(character_limiter($berita['isi']), 50) ?></p>

			<p class="text-right"><a href="<?php echo base_url('home2/read/' . $berita['slug_berita']) ?>">Baca detail...</a></p>
		</div>
	<?php $no++;
	} ?>
</div>